...
class Render{
    ...
    public:
        ...
        void rayColor(const Scene& scene,Ray &ray,RandomReal& generator ,Color& outColor);
    ...
    private:
        void rayColor(const Scene& scene,Ray &ray,uint16_t reflectionLeft,RandomReal& generator,Color& outColor);
    private:
        Scene& m_scene;
        Camera m_camera;
